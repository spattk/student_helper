...
987	Create Story API	Kanban board story create API	2	IN_REVIEW
762	Create UI	Create Website UI	8	COMPLETED
902	Create Story API	Kanban board story create API	2	COMPLETED
904	Story Status Update	Update the dropdown of Story	2	IN_REVIEW
906	Client side Rendering	Hyperlink and control flow within the text.	4	TODO
451	Train ML Model	Train Search Engine Model	8	TODO
905	CSR	Client Side Rendering on React	2	IN_PROGRESS
903	Mock Data	Fill Mock Data in DB	4	COMPLETED
115	Create Story API	Kanban board story create API	2	TODO
\.
